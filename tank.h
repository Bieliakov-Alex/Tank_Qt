/* Класс, который хранит информацию о сущностях в игре. Изначально планировался только для хранения информации о танках,
 * но позже выяснилось, что так же подходит для хранения информации о снарядах*/
